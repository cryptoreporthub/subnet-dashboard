...
- Models: Composer 2.5 default build; Cursor Grok (`grok-4.5-fast-xhigh` default, `grok-4.5-xhigh` for high-risk N3/N1) per `cursor-agents-communication/model-guide.md` §2/§4.

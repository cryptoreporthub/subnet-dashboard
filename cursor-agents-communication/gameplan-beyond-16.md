...
**Status:** DRAFT 2026-07-15 · **recommended mix locked** (not OR menus) · do not implement until §16 done + this approved  
**Depends on:** §16 Complete (`gameplan-phase-16.md`)  
**Companion:** what Ditto left out of the trust-gap slice

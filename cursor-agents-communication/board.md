...
**Models:** Grok LOCK + Composer build only (usage limit — no Sonnet primary)  
...
| Phase B Telegram author trust (LB-8 untouched) | **OPEN** #721 MERGEABLE CI green (may still be draft) |

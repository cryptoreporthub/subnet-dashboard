...
- **C-016:** Tracer bundle ACCEPTED (C-016.tracer.1) — path-split confirmed code-only; ConfigTruth fly.toml slice still awaiting; claim not VERIFIED
...
- X-C-016-CAP: open (awaiting C-016 bundles)

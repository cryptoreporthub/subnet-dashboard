...
| P3-3 | `ui-legacy.css` purge | Lower — large diff, incremental | **P3-3a–f:** conf-state, utilities, horizon/pump chip, dead k3-orb shell, drawer/weight-nudge, **pump desk CSS → ui.css** |

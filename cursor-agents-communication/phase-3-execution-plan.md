...
| P3-3 | `ui-legacy.css` purge | Lower — large diff, incremental | **P3-3a–g:** conf-state, utilities, horizon/pump chip, k3-orb shell, drawer/weight-nudge, pump desk, **message-intel desk → ui.css** |

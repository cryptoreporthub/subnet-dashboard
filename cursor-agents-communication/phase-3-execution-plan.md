...
| P3-3 | `ui-legacy.css` purge | Lower — large diff, incremental | **P3-3a–h:** … message-intel desk, **council home shell + driver.js tour → ui.css**; **P3-3i:** home drawers + §21 modules + living focus/proof band/inv tables → ui.css |

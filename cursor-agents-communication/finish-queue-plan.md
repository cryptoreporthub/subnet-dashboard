...
**Baseline main:** `a6dbec3` — #604 SS-TG trending · #603 live-cache proxy · #602 readiness proxy · #601 learning deploy check  
...
**Problem:** `board.md` has unresolved merge conflict; locks stale vs `main=a6dbec3`.

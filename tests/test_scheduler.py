...
class TestSubnetFiltering:
    ...
    def test_filter_excludes_high_stake_subnets(self):
        """Subnets with total_stake >= 400000 TAO should be excluded."""
        registry = {
            "0": {"staking_data": {"total_stake": 500000}},  # Excluded
            "1": {"staking_data": {"total_stake": 399999}},  # Included
            "2": {"staking_data": {"total_stake": 400000}},  # Excluded (boundary)
            "3": {"staking_data": {"total_stake": 350000}},  # Included
        }
    ...
    def test_filter_handles_missing_stake_data(self):
        ...
        registry = {
            ...
            "2": {"staking_data": {"total_stake": 350000}},  # Has stake
        }
        scheduler = AdversarialScheduler(stake_threshold_tao=400000)
        filtered = scheduler._filter_low_mid_cap_subnets(registry)

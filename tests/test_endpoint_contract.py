...
CONTRACT = [
    ...
    ("GET", "/preview/k3-pump-alert", None),
    ("GET", "/preview/k3-pump-alert-scan", None),
    ("GET", "/preview/pump-desk-polish", None),
    ("GET", "/preview/pump-desk-full", None),
    ("GET", "/preview/listening-post", None),
    ("GET", "/pump", None),
    ...
    ("GET", "/api/ops/live", None),
    ("GET", "/api/ops/worker-peer", None),
    ("GET", "/api/ops/evidence", None),
    ...
    ("GET", "/api/daily-pick/weighed", None),
    ...
    ("GET", "/api/message-intel/authors", None),
    ("GET", "/api/message-intel/topics", None),

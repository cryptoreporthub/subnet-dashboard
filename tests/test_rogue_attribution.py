...
rogue bucket never touching scored weights, rogue_stats shape, and the
rebalance math (quant 2.00 -> 1.50).
"""
...
from internal.learning.weight_deltas import _ROGUE_PROMOTION_RULE
...
def test_rogue_promotion_rule_defined() -> None:
    assert "hit_rate >= 0.55" in _ROGUE_PROMOTION_RULE
    assert "30" in _ROGUE_PROMOTION_RULE
